...
const PricingSection1 = () => {
  ...
  return (
    ...
    <>
    {
        ...
        <div className="bg-zinc-950   border-gray-600 border-[1px] text-white mt-40 mb-40 py-8 flex flex-col lg:flex-row p-10 justify-start item-start lg:justify-between max-w-[1280px] mx-auto rounded-xl shadow-lg h-full gap-20">
        ...
        <div className="lg:w-1/4  flex flex-col items-center justify-between min-h-[300px]  border-white border-l-[1px] border-dashed  mt-10">
          ...
          <div className="mt-auto">
            <button onClick={()=> setIsopen(true)}className="px-14 py-2 bg-gradient-to-t from-gray-400 to-slate-50 text-black rounded-md hover:text-white hover:border hover:border-white hover:bg-none  transition duration-300">
              View our pricing
            </button>
          </div>
        </div>
