...
const Index = () => {
  return (
    <div className=" h-full bg-[#09090b] max-w-[1280px] mx-auto text-white z-[5]">
      <div className="flex flex-col md:flex-row justify-center max-w-[1280px] gap-8 mx-auto py-8">
        {/* Left Section */}
        <div className="flex flex-col z-[5] max-w-[300px]">
          <div className="flex w-auto md:h-[396px] pt-[32px] pr-[32px] pb-[32px] pl-[32px] flex-col justify-center items-start flex-nowrap bg-[#191934]  bg-no-repeat rounded-[24px]  z-[27] gap-10">
          ...
          <div className="flex h-[244px] pt-[34px] pr-[32px] pb-[30px] pl-[32px] flex-col mt-8 gap-[20px]   flex-nowrap bg-[#31316433] bg-no-repeat rounded-[24px] z-[34]">
            <div className="flex flex-col gap-[12px] items-center self-stretch shrink-0 flex-nowrap relative z-[35]">
              ...
              </span> <span className="flex w-full h-[20px] justify-start items-end  text-[18px] font-normal leading-[13px] text-[#b1a0fc] relative text-start whitespace-nowrap z-[37] ">
              Traditional System
              </span>
          ...
          <div className="w-full h-[140px] pt-[32px] pr-[32px] pb-[32px] pl-[32px] flex  items-start flex-nowrap bg-[#31316433] mt-8 bg-no-repeat rounded-[24px]  z-[44]">
            
            
            <div className="bg-[#2a2a6f33] p-2 rounded-md">
              <button className="md:flex items-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 px-8 py-2 rounded-md text-white text-md flex ">
                <img src="/assets/images/image_icon.png" className="w-6 h-6" />{" "}
                Talk To an Expert
              </button>
            </div>
        ...
        {/* Right Section */}
        <div className="flex flex-col z-[5] max-w-[400px]">
